...
int face_detect_postprocess(face_detect_out_t* pface_det_result )
{
    ...
    if (valid_32 == 1)
    {
        ...
        if (valid_16 == 1)
        {
            ...
            if (valid_8 == 1)
            {
                ...
                retina_result(480, 0.8, pbox32, prob32, pland32, pface_det_result);
                retina_result(1920, 0.8, pbox16, prob16,pland16, pface_det_result);
                retina_result(7680, 0.8, pbox8, prob8,pland8, pface_det_result);
            }
            else
            {
                retina_result(480, 0.8, pbox32, prob32,pland32, pface_det_result);
        ...
        {
        retina_result(480, 0.6, pbox32, prob32, pland32, pface_det_result);
    ...
    if (valid_16 == 1 && valid_32 == 0 )
    {
        ...
        else retina_result(1920, 0.8, pbox16, prob16,pland16, pface_det_result);
    }

    if (valid_8 == 1 && valid_16 == 0 && valid_32 == 0 )
    {
        retina_do_nms_sort(pbox8, prob8, 7680, 0.2);
        retina_result(7680, 0.4, pbox8, prob8, pland8, pface_det_result);
    }
    return 0;
}
